...
public class ReferenceConnection {
    private String p_score, URL;
    private String major;
    private String m_name;

    private  int count=0;

    public ReferenceConnection(String major, String m_name, String p_score ,String url) {
        this.major = major;
        this.m_name = m_name;
    ...
    public boolean requestLogin() {
                ...
                try{
                    ...
                    nameValuePairs.add(new BasicNameValuePair("p_score",msg3));
